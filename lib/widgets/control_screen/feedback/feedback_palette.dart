...
abstract final class FeedbackPalette {
  ...
  /// Confirmed-ON colour for [variant]. E-STOP's status bit is confirmed ON
  /// exactly when the safety channel has tripped (see
  /// PlcOutputCommand.fromStatusNotification's active-high DF1 parsing), so
  /// this is the danger state and keeps the safety red; every other channel
  /// uses the app's generic output amber.
