...
class _GaugePotentiometerPainter extends CustomPainter {
    ...
    canvas.drawCircle(
      ...
      Paint()
        ..shader = const RadialGradient(
          ...
          colors: [Color(0xFF2C3E50), Color(0xFF1A2634), Color(0xFF0D1520)],
  ...
  void _drawGaugeLabels(Canvas canvas, Offset center, double side) {
    ...
    const maxAngle = _kStartAngle + _kSweepAngle;
  ...
  void _drawKnobBody(Canvas canvas, Offset center, double knobR) {
    ...
    for (var i = 0; i < 12; i++) {
      ...
      canvas.drawCircle(
        center + Offset(math.cos(angle) * dotR, math.sin(angle) * dotR),
  ...
  void _drawValueDisplay(Canvas canvas, Offset center, double side) {
    ...
    valueTP.paint(canvas, Offset(center.dx - valueTP.width / 2, valueY));
